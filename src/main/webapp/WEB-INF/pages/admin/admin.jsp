    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href="admin/admin_console">
                    <span>起灵小说网后台管理</span>
                </div>
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="home" class="layui-nav-item layui-this">
                        <a href="javascript:" lay-href="admin/admin_console" lay-tips="控制台" lay-direction="2">
                            <i class="layui-icon layui-icon-home"></i>
                            <cite>控制台</cite>
                        </a>
                    </li>
                    <li data-name="novel" class="layui-nav-item">
                        <a href="javascript:" lay-tips="小说管理" lay-direction="2">
                            <i class="layui-icon iconfont iconxiaoshuo"></i>
                            <cite>小说管理</cite>
                        </a>
                        <dl class="layui-nav-child">
                            <dd data-name="admin/admin_type" class="layui-this">
                                <a lay-href="admin/admin_type">分类管理</a>
                            </dd>
                            <dd data-name="admin/admin_novel">
                                <a lay-href="admin/admin_novel">小说管理</a>
                            </dd>
                        </dl>
                    </li>
                    <li data-name="user" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="admin/admin_user">会员管理</a>
                            </dd>
                            <dd>
                                <a lay-href="admin/admin_author">作者管理</a>
                            </dd>
                            <dd>
                                <a lay-href="admin/admin_administrators">管理员</a>
                            </dd>
                        </dl>
                    </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="admin/admin_console" lay-attr="admin/admin_console" class="layui-this"><i
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="admin/admin_console" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
